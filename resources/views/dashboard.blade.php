    ...
    <div class="col-lg-6 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <p>Tambahkan ilustrasi SVG berkualitas ke proyek Anda.</p>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>Template ini menggunakan Bootstrap 4 utility classes untuk mengurangi CSS bloat dan meningkatkan performa halaman.</p>
                <p class="mb-0">Pastikan Anda familiar dengan framework Bootstrap sebelum mulai mengembangkan.</p>
            </div>
        </div>
    </div>
</div>
